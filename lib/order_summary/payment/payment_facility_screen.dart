...
class PaymentFacilityScreen extends StatelessWidget {
  const PaymentFacilityScreen({
    super.key,
  });
      ...
      floatingActionButton: Padding(
        ...
        child: CustomButton(
            ...
            onPressed: () {
              ...
              //     context,
              //     MaterialPageRoute(
              //       builder: (context) =>  const paymentSuccessInspectionScreen(isFromDrop: false, ),
              //     ));
              //   }else{
              //      Navigator.pushReplacement(
              //     context,
              //     MaterialPageRoute(
              //       builder: (context) =>  const paymentSuccessInspectionScreen(isFromDrop: true, ),
              //     ));
              //   }
