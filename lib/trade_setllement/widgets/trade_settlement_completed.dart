...
class TradeSettlementCompletedWidgets extends StatefulWidget {
  const TradeSettlementCompletedWidgets({super.key});

  @override
  State<TradeSettlementCompletedWidgets> createState() => _TradeSettlementCompletedWidgetsState();
}

class _TradeSettlementCompletedWidgetsState extends State<TradeSettlementCompletedWidgets> {
