          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    priceMethod(title1: "Date", title2: "10-Oct-2023"),
                    priceMethod(title1: "Time", title2: "02:00 PM-05:00 PM")
                  ],
                ),
              ),
              buildVSpacer(4.h),

              CompletedScreenFieldWidget(title: "INSPECTOR INFORMATION"),
              buildVSpacer(2.h),
              Align(
                alignment: Alignment.centerLeft,
                child: _buildText(
              ...
              CustomButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => TrackingAndPackagingScreen(),
                      ));
                },
                color: buttonColor,
              ),
