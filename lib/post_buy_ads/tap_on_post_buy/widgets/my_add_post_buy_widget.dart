...
class MyAdWidgetForPostBuy extends StatefulWidget {
  const MyAdWidgetForPostBuy({super.key});

  @override
  State<MyAdWidgetForPostBuy> createState() => _MyAdWidgetForPostBuyState();
}

class _MyAdWidgetForPostBuyState extends State<MyAdWidgetForPostBuy> {
  @override
          ...
          GestureDetector(
            onTap: () {
              Navigator.of(context).pushReplacement(
                MaterialPageRoute(
                  builder: (context) =>
                      MyAdonTapScreenPostBuy(someData: SelectedTab.myAds),
                ),
              );
            },
            child: Container(
