...
class WishKaroOrderReadyScreen extends StatefulWidget {
  const WishKaroOrderReadyScreen({super.key});

  @override
  State<WishKaroOrderReadyScreen> createState() =>
      _WishKaroOrderReadyScreenState();
}

class _WishKaroOrderReadyScreenState extends State<WishKaroOrderReadyScreen> {
  @override
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      context,
                      MaterialPageRoute(
                        builder: (context) => const OrderSummaryFromMyOrdersScreen(isFromWish: true),
                      ));
                          },
                          color: buttonColor,
                          textColor: black,
