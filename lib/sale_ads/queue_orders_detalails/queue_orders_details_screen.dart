...
class QueueOrdersDetailsScreen extends StatelessWidget {
  const QueueOrdersDetailsScreen({
    super.key,
  });
...
Column(
  children: [
    CustomButton3(
                    ...
                    buildVSpacer(2.h),
                    _buildText(title: "Bank Transaction\nSuccessfull\nAPI Data",
                    size: 12.px,fontWeight: FontWeight.w600
                    )
  ],
),
buildHSpacer(6.w),
